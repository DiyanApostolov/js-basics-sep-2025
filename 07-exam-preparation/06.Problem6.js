function six (num1, num2){
    ...
    let start = String(num1); // подсигуряваме си, че входните числа ще ги вземем като текст!
    let end = String(num2); // подсигуряваме си, че входните числа ще ги вемем като текст!
